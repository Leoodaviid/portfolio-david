          ...
          <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div className="profile-wrapper">
              ...
              <p>
                ...
                anos de experiência como desenvolvedor front-end, Trabalhei como
                desenvolvedor Front-End durante 4 anos na Unijaguaribe. Sempre
                fui fascinado pelo aspecto dinâmico e criativo deste campo e
                estou confiante de que minhas habilidades e experiência me
                tornam uma excelente opção para uma função em qualquer empresa
                que necessite desse segmento. Fiz vários cursos de
                desenvolvimento front-end e tenho trabalhado em projetos
                pessoais para desenvolver ainda mais minhas habilidades. Estou
                familiarizado com tecnologias como HTML, CSS, JavaScript,
                TypeScript e React, e estou ansioso para aplicar meu
                conhecimento em um ambiente profissional.
              </p>
